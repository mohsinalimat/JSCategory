...
static NSTimeInterval js_CGImageSourceGetGIFFrameDelayAtIndex(CGImageSourceRef source, size_t index)
{
                                ...
                                scale:(CGFloat)scale
{
    ...
    {
        NSTimeInterval delay = js_CGImageSourceGetGIFFrameDelayAtIndex(source, i);
...
{
    return [self js_imageWithPDF:dataOrPath
                          resize:NO
                            size:CGSizeZero];
}
