...
+ (UIImage *)js_imageWithSmallGIFData:(NSData *)data
    ...
    if (count <= 1) {
        ...
        return [self.class imageWithData:data
                                   scale:scale];
    }
    ...
    UIImage *image = [self.class animatedImageWithImages:array
                                                duration:totalTime];
...
+ (UIImage *)js_imageWithPDF:(id)dataOrPath {
    return [self _js_imageWithPDF:dataOrPath
                           resize:NO
                             size:CGSizeZero];
}
...
+ (UIImage *)js_imageWithEmoji:(NSString *)emoji
    ...
    NSAttributedString *str = [[NSAttributedString alloc] initWithString:emoji
                                                              attributes:@{ (__bridge id)kCTFontAttributeName:(__bridge id)font, (__bridge id)kCTForegroundColorAttributeName:(__bridge id)[UIColor whiteColor].CGColor }];
...
+ (UIImage *)js_imageWithColor:(UIColor *)color {
    return [self js_imageWithColor:color
                              size:CGSizeMake(1, 1)];
}
...
- (UIImage *)js_imageByResizeToSize:(CGSize)size
    ...
    [self js_drawInRect:CGRectMake(0, 0, size.width, size.height)
...
- (UIImage *)js_imageByRotate:(CGFloat)radians
...
- (UIImage *)js_imageByRotateLeft90 {
    return [self js_imageByRotate:DegreesToRadians(90)
                          fitSize:YES];
}
...
- (UIImage *)js_imageByRotate180 {
    return [self _js_flipHorizontal:YES
                           vertical:YES];
}

- (UIImage *)js_imageByFlipVertical {
    return [self _js_flipHorizontal:NO
                           vertical:YES];
}
...
- (UIImage *)js_imageByGrayscale {
    return [self js_imageByBlurRadius:0
                            tintColor:nil
                             tintMode:0
                           saturation:0
                            maskImage:nil];
...
- (UIImage *)js_imageByBlurSoft {
    return [self js_imageByBlurRadius:60
...
- (UIImage *)js_imageByBlurExtraLight {
    return [self js_imageByBlurRadius:40
...
- (UIImage *)js_imageByBlurWithTint:(UIColor *)tintColor {
    ...
    return [self js_imageByBlurRadius:20
...
- (UIImage *)js_imageByBlurRadius:(CGFloat)blurRadius
    ...
    if (!hasBlur && !hasSaturation) {
        return [self _js_mergeImageRef:imageRef
                             tintColor:tintColor
    ...
    if (hasNewFunc) {
        ...
        outputImage = [self _js_mergeImageRef:effectCGImage
                                    tintColor:tintColor
                                tintBlendMode:tintBlendMode
                                    maskImage:maskImage
                                       opaque:opaque];
...
#pragma mark 私有方法
+ (UIImage *)_js_imageWithPDF:(id)dataOrPath
                       resize:(BOOL)resize
                         size:(CGSize)size {
...
- (UIImage *)_js_flipHorizontal:(BOOL)horizontal
